...
/**
 * SubscriptionPlanOutput Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SubscriptionPlanOutput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubscriptionPlanOutput';
    ...
    public function setWebhookUrl($webhook_url)
    {
        if (!is_null($webhook_url) && (mb_strlen($webhook_url) > 200)) {
            throw new \InvalidArgumentException('invalid length for $webhook_url when calling SubscriptionPlanOutput., must be smaller than or equal to 200.');
        }
    ...
    public function setApplicationUrl($application_url)
    {
        if (!is_null($application_url) && (mb_strlen($application_url) > 200)) {
            throw new \InvalidArgumentException('invalid length for $application_url when calling SubscriptionPlanOutput., must be smaller than or equal to 200.');
        }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 60)) {
            throw new \InvalidArgumentException('invalid length for $name when calling SubscriptionPlanOutput., must be smaller than or equal to 60.');
        }
        if (!is_null($name) && (mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling SubscriptionPlanOutput., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 300)) {
            throw new \InvalidArgumentException('invalid length for $description when calling SubscriptionPlanOutput., must be smaller than or equal to 300.');
        }
    ...
    public function setGracePeriod($grace_period)
    {
        ...
        if (!is_null($grace_period) && ($grace_period > 7)) {
            throw new \InvalidArgumentException('invalid value for $grace_period when calling SubscriptionPlanOutput., must be smaller than or equal to 7.');
        }
        if (!is_null($grace_period) && ($grace_period < 0)) {
            throw new \InvalidArgumentException('invalid value for $grace_period when calling SubscriptionPlanOutput., must be bigger than or equal to 0.');
        }
