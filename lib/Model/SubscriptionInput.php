...
class SubscriptionInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setCustomerEmail($customer_email)
    {
        if ((mb_strlen($customer_email) > 254)) {
            throw new \InvalidArgumentException('invalid length for $customer_email when calling SubscriptionInput., must be smaller than or equal to 254.');
        }
        if ((mb_strlen($customer_email) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_email when calling SubscriptionInput., must be bigger than or equal to 1.');
        }
