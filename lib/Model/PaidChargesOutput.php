...
/**
 * PaidChargesOutput Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PaidChargesOutput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaidChargesOutput';
    ...
    protected static $openAPITypes = [
        ...
        'settleevent' => '\OpenAPI\Client\Model\SettleEventOutput'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['settleevent'] = $data['settleevent'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['settleevent'] === null) {
            $invalidProperties[] = "'settleevent' can't be null";
        }
    ...
    public function setObject($object)
    {
        ...
        if (!is_null($object) && (mb_strlen($object) < 1)) {
            throw new \InvalidArgumentException('invalid length for $object when calling PaidChargesOutput., must be bigger than or equal to 1.');
        }
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling PaidChargesOutput., must be smaller than or equal to 2147483647.');
        }
        if (($amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling PaidChargesOutput., must be bigger than or equal to 0.');
        }
    ...
    public function setDescription($description)
    {
        if ((mb_strlen($description) > 60)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PaidChargesOutput., must be smaller than or equal to 60.');
        }
        if ((mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PaidChargesOutput., must be bigger than or equal to 1.');
        }
    ...
    public function setPaymentRequest($payment_request)
    {
        ...
        if ((mb_strlen($payment_request) < 1)) {
            throw new \InvalidArgumentException('invalid length for $payment_request when calling PaidChargesOutput., must be bigger than or equal to 1.');
        }
    ...
    public function setWebpayCode($webpay_code)
    {
        if (!is_null($webpay_code) && (mb_strlen($webpay_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $webpay_code when calling PaidChargesOutput., must be smaller than or equal to 10.');
        }
        if (!is_null($webpay_code) && (mb_strlen($webpay_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $webpay_code when calling PaidChargesOutput., must be bigger than or equal to 1.');
        }
     ...
     * Gets settleevent
     *
     * @return \OpenAPI\Client\Model\SettleEventOutput
     */
    public function getSettleevent()
    {
        return $this->container['settleevent'];
    }

    /**
     * Sets settleevent
     *
     * @param \OpenAPI\Client\Model\SettleEventOutput $settleevent settleevent
     *
     * @return self
     */
    public function setSettleevent($settleevent)
    {
        $this->container['settleevent'] = $settleevent;
